...
exports.RecipeModule = RecipeModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [recipe_service_1.RecipesService],
        imports: [
            typeorm_1.TypeOrmModule.forFeature([recipe_entity_1.RecipeEntity]),
            serve_static_1.ServeStaticModule.forRoot({
                rootPath: (0, path_1.join)(process.cwd(), 'uploads', 'recipes'),
